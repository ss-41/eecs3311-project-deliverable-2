...
public class RegisterPanel extends JPanel {
    ...
    private void registerUser() {
        ...
        String stud_OR_orgID =
                stud_OR_orgIDField.getText().trim();
        ...
        switch (selectedAccountType) {
            ...
            case "Student":
                accountType =
                        new AccountType(1, "Student", 20.00);
                break;

            case "Faculty":
                accountType =
                        new AccountType(2, "Faculty", 30.00);
                break;

            case "Staff":
                accountType =
                        new AccountType(3, "Staff", 40.00);
                break;

            case "Partner":
                accountType =
                        new AccountType(4, "Partner", 50.00);
                break;
        ...
        try {
            ...
            User newUser = accountController.registerUser(
                    name,
                    email,
                    password,
                    stud_OR_orgID,
